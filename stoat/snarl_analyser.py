...
if __name__ == "__main__" :
    ...
    # python3 stoat/snarl_analyser.py tests/simulation/binary/merged_output.vcf tests/simulation/binary/snarl_paths.tsv -q tests/simulation/binary/phenotype.tsv -o tests/binary_tests_output/binary_output.tsv
    ...
    # python3 stoat/snarl_analyser.py tests/simulation/quantitative/merged_output.vcf tests/simulation/quantitative/snarl_paths.tsv -q tests/simulation/quantitative/phenotype.tsv -o tests/quantitative_tests_output/quantitative_output.tsv
