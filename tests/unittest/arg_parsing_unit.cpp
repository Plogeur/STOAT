...
TEST_CASE("Binary phenotype parsing", "[parse_binary_pheno]") {
    ...
    SECTION("Invalid header") {
        ...
        REQUIRE_THROWS_AS(parse_binary_pheno(file_path, list_samples), std::invalid_argument);
    }
    ...
    SECTION("Non-binary phenotype value") {
        ...
        REQUIRE_THROWS_AS(parse_binary_pheno(file_path, list_samples), std::runtime_error);
    }
...
TEST_CASE("Quantitative phenotype parsing", "[parse_quantitative_pheno]") {
    SECTION("Valid quantitative phenotype file") {
        ...
        auto result = parse_quantitative_pheno(file_path, list_samples);
    ...
    SECTION("Invalid header in quantitative phenotype file") {
        ...
        REQUIRE_THROWS_AS(parse_quantitative_pheno(file_path, list_samples), std::invalid_argument);
    }
    ...
    SECTION("Non-numeric phenotype value") {
        ...
        REQUIRE_THROWS_AS(parse_quantitative_pheno(file_path, list_samples), std::runtime_error);
    }
