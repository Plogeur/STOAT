...
class Partitioner {
    ...
    public:
        Partitioner(std::set<sample_hap_t> all_sample_haplotypes) :
...
class PathPartitioner : public Partitioner {
    public:
        ...
        PathPartitioner(std::set<sample_hap_t> all_sample_haplotypes) : Partitioner(std::move(all_sample_haplotypes)) {}
        ...
        std::vector<std::set<sample_hap_t>> get_walk_sets(const handlegraph::PathPositionHandleGraph& graph, const bdsg::SnarlDistanceIndex& distance_index, const bdsg::net_handle_t& snarl) const;
        ...
        std::vector<std::set<sample_hap_t>> get_start_edge_sets(const handlegraph::PathPositionHandleGraph& graph, const bdsg::SnarlDistanceIndex& distance_index, const bdsg::net_handle_t& snarl) const;
