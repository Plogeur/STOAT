   ...
   std::string subcommand = argv[1];
    ...
    if (subcommand == "vcf") {
        ...
        if (make_bed) {
            ...
            stoat_vcf::chromosome_chuck_binary(*stree, ptr_vcf, hdr, rec, list_samples, snarls_chr, binary, covariate, maf, kinship, num_threads, table_threshold, regression_dir, output_binary);
